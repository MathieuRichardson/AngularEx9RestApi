...
export class CustomerService extends SharedService{
  ...
  public createCustomer(customer: Customer): Observable<Customer> {
    ...
    const apiMethod = `${API_URL}/api/Customers/Create`;
    return this.http
      .post<Customer>(apiMethod, customer, this.httpOptions())
  ...
  public updateCustomer(customer: Customer): Observable<boolean> {
    ...
    //Change out to call to REST API
    const apiMethod = `${API_URL}/api/Customers/Update/`;
    return this.http
      .post<boolean>(apiMethod, customer, this.httpOptions())
      .pipe(catchError(this.handleError));
  }
  ...
  public deleteCustomer(id: number): Observable<boolean> {
    ...
    //Change out to call to REST API
    const apiMethod = `${API_URL}/api/Customers/Delete/${id}`;
    return this.http
      .post<boolean>(apiMethod, this.httpOptions())
      .pipe(catchError(this.handleError));
  }
  ...
  public getCustomers(): Observable<Customer[]> {
    ...
    //Change out to call to REST API
    const apiMethod = `${API_URL}/api/Customers`;

    return this.http
      .get<Customer[]>(apiMethod)
      .pipe(catchError(this.handleError));
    //Change out to call to REST API
  }
  ...
  public getCustomer(id: number): Observable<Customer> {
    ...
    const apiMethod = `${API_URL}/api/Customers/details/${id}`;
    return this.http
      .get<Customer>(apiMethod)
      .pipe(catchError(this.handleError));
